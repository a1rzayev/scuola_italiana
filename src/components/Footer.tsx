...
export function Footer() {
  ...
  return (
    <footer className="border-t border-gray-100 dark:border-trueGray-800">
      <Container>
        <div className="grid grid-cols-1 gap-10 pt-12 pb-10 lg:grid-cols-4">
          {/* Brand column */}
          <div className="lg:col-span-2">
            ...
            <p className="max-w-xs mt-4 text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
            ...
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-600 dark:text-gray-400 hover:text-italia-600 dark:hover:text-italia-400 transition-colors duration-200"
                  >
                    {link.name}
                  </Link>
                </li>
        ...
        {/* Copyright */}
        <div className="border-t border-gray-100 dark:border-trueGray-800 py-6 text-sm text-center text-gray-500 dark:text-gray-400">
