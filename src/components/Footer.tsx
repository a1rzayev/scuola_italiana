            ...
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {footerNav.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-italia-500 focus:text-italia-500 focus:bg-italia-100 focus:outline-none dark:focus:bg-trueGray-700"
                >
                  {item.name}
                </Link>
              ))}
