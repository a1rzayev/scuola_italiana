    ...
    <Container>
      <section className="pt-12 pb-16">
        ...
        <div className="grid gap-8 mt-12 md:grid-cols-2">
          <Link
            href="/services/cafe"
            className="block p-8 transition rounded-xl bg-gray-50 dark:bg-trueGray-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 border border-gray-100 dark:border-trueGray-700"
          >
            ...
            <span className="inline-flex items-center mt-4 text-indigo-600 dark:text-indigo-400 font-medium">
              Visit the café →
            </span>
          </Link>
          <Link
