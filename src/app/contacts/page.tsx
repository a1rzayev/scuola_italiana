        ...
        <div className="mt-2 grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
          <div className="space-y-4">
            ...
            <RevealOnScroll delay={0}>
              <div className="flex gap-4 p-6 rounded-2xl bg-gray-50 dark:bg-trueGray-800 border border-gray-100 dark:border-trueGray-700 shadow-card hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-300">
                <div className="flex-shrink-0 mt-0.5">
                  <div className="w-9 h-9 rounded-xl bg-italia-500/10 dark:bg-italia-900/40 flex items-center justify-center">
              ...
              <div className="flex gap-4 p-6 rounded-2xl bg-gray-50 dark:bg-trueGray-800 border border-gray-100 dark:border-trueGray-700 shadow-card hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-300">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="underline-wipe mt-1 inline-block text-sm text-italia-600 dark:text-italia-400 hover:text-italia-700 dark:hover:text-italia-300 transition-colors duration-200"
                  >
                    scuola@litad.az
                  </a>
                </div>
          ...
          <div className="space-y-4 lg:sticky lg:top-24 self-start">
            <RevealOnScroll direction="right">
              ...
              <div className="flex flex-col gap-4 p-6 rounded-2xl bg-italia-50 dark:bg-italia-900/25 border border-italia-200 dark:border-italia-800/50">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center justify-center gap-2 px-5 py-3 text-sm font-semibold text-white bg-italia-600 rounded-xl hover:bg-italia-700 dark:bg-italia-500 dark:hover:bg-italia-600 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md w-full"
                >
                  {t.contacts.registrationButton}
                  <svg className="w-4 h-4 transition-transform duration-200 group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
            ...
            <RevealOnScroll direction="right" delay={1}>
